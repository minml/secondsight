...
class CheckoutForm extends Submission {
  ...
  public function __construct($params = array()) {
    ...
    $this->defaults('required', array('name', 'email', 'address'));
    $this->defaults('keep',     array('name', 'email', 'address'));
  ...
  function body() {
    ...
    if(empty($body)) {
      ...
      $body = snippet('checkoutform.mail', array(), true);
